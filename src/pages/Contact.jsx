      ...
      <div class="container my-12 mx-auto px-2 md:px-4">
        <section class="mb-32">
          ...
          <div class="flex flex-wrap justify-center items-center ">
            <form class="sm:mb-12 sm:w-full shrink-0 grow-0 basis-auto md:px-3 mb-0 w-5/12 px-6">
            ...
            <div class="sm:w-full shrink-0 grow-0 basis-auto w-7/12">
              <div class="flex flex-wrap">
                <div class="mb-12 sm:w-full shrink-0 grow-0 basis-auto lg:w-6/12 md:px-3 lg:px-6">
